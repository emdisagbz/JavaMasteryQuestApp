document.addEventListener("DOMContentLoaded", function() {
	...
	let BW3F3totalScore = points; // Initialize total score
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("BW3F3totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
    ...
    confirmFinishButton.addEventListener("click", function() {
        window.location.href = '/Capstone/BW3P3Floor';
    });
   ...
   function showCompletionWarning() {
    ...
    BW3F3totalScore = localStorage.getItem("BW3F3totalScore") ? parseInt(localStorage.getItem("BW3F3totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		BW3F3totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("BW3F3totalScore", BW3F3totalScore);
	}
