document.addEventListener("DOMContentLoaded", function() {
	...
	let BW1F2totalScore = points; // Initialize total score
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("BW1F2totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
    ...
    confirmFinishButton.addEventListener("click", function() {
        window.location.href = '/Capstone/BW1P2Floor';
    });
   ...
   function showCompletionWarning() {
    ...
    BW1F2totalScore = localStorage.getItem("BW1F2totalScore") ? parseInt(localStorage.getItem("BW1F2totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		BW1F2totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("BW1F2totalScore", BW1F2totalScore);
	}
