document.addEventListener("DOMContentLoaded", function() {
	...
	let AW3F2totalScore = points; // Initialize total score
    ...
    const questions = [
        {
            ...
            choices: [
                ...
                "B) A blueprint of a class that contains abstract methods.",
                "C) A method that can be called without creating an object.",
                "D) A class that implements another class."
            ],
            answer: "B",
            hints: [
                "Hint 1: It is implemented by other classes to provide specific behavior.",
                "Hint 2: It contains method signatures but no implementations.",
                "Hint 3: An interface can be implemented by multiple classes."
            ]
        },
        {
            type: "Multiple Choice",
            ...
            answer: "C",
            hints: [
                "Hint 1: It is used to declare a completely abstract class.",
                "Hint 2: It allows multiple classes to share a common set of method signatures.",
                "Hint 3: The methods defined in an interface are abstract by default."
            ]
        },
        {
            type: "Multiple Choice",
            ...
            answer: "B",
            hints: [
                "Hint 1: This process allows the class to provide functionality for the abstract methods.",
                "Hint 2: It allows a class to adopt the behavior described in the interface.",
                "Hint 3: Multiple interfaces can be implemented by a single class."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "A blueprint of a class that contains abstract methods.",
            answer: "Interface",
            hints: [
                "Hint 1: It defines methods but does not provide their implementation.",
                "Hint 2: A class that implements this must provide concrete methods for each abstract method.",
                "Hint 3: It allows a class to adopt multiple sets of behaviors from different interfaces."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "The keyword used to define a completely abstract class in Java.",
            answer: "interface",
            hints: [
                "Hint 1: It precedes the interface name.",
                "Hint 2: This keyword is used to declare a group of abstract methods.",
                "Hint 3: It must be implemented by a class."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "The keyword used by a class to provide the implementation of an interface.",
            answer: "implements",
            hints: [
                "Hint 1: It indicates that a class is using an interface.",
                "Hint 2: This keyword allows a class to define the methods of the interface.",
                "Hint 3: A class can use this keyword to implement multiple interfaces."
            ]
...

        {
            ...
            answer: "Dog barks",
            image: "/image/Custom/AW3P1F2WTO1.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            ...
            image: "/image/Custom/AW3P1F2WTO2.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            ...
            image: "/image/Custom/AW3P1F2WTO3.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            ...
            image: "/image/Custom/AW3P1F2WTO4.png"
        },
        {
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("AW3F2totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
   ...
   function showCompletionWarning() {
    ...
    AW3F2totalScore = localStorage.getItem("AW3F2totalScore") ? parseInt(localStorage.getItem("AW3F2totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		AW3F2totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("AW3F2totalScore", AW3F2totalScore);
	}
