document.addEventListener("DOMContentLoaded", function() {
	...
	let AW1F6totalScore = points; // Initialize total score
    ...
    const questions = [
        {
            ...
            choices: [
                ...
                "D) Using multiple loops in a method"
            ],
            answer: "B",
            hints: [
                "Hint 1: It involves methods having the same name but different parameter lists.",
                "Hint 2: It allows methods with the same name to behave differently based on the arguments passed.",
                "Hint 3: The return type can be the same or different for overloaded methods."
            ]
        },
        {
            type: "Multiple Choice",
            ...
            choices: [
                ...
                "B) It increases the readability of the program",
                "C) It decreases the performance",
                "D) It limits the use of methods"
            ],
            answer: "B",
            hints: [
                "Hint 1: It allows the same method name to be reused, reducing code duplication.",
                "Hint 2: Overloading helps manage different input types and argument counts.",
                "Hint 3: It simplifies the interface by providing multiple methods with the same logical functionality."
            ]
        },
        {
            type: "Multiple Choice",
            ...
            choices: [
                ...
                "B) By their method name",
                "C) By their parameter list",
                "D) By their access modifier"
            ],
            answer: "C",
            hints: [
                "Hint 1: The number, type, and order of parameters must differ.",
                "Hint 2: The return type alone does not distinguish overloaded methods.",
                "Hint 3: The method name remains the same but the parameters change."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "The concept of having multiple methods with the same name but different parameters.",
            answer: "Method overloading",
            hints: [
                "Hint 1: It enhances method usability and readability.",
                "Hint 2: It makes a method name more versatile by allowing it to handle different inputs.",
                "Hint 3: The return type can vary but is not what makes the methods different."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "The list of arguments that distinguishes overloaded methods.",
            answer: "Parameter list",
            hints: [
                "Hint 1: It specifies the number and type of parameters a method accepts.",
                "Hint 2: It appears inside the parentheses in the method declaration.",
                "Hint 3: It is the key factor in differentiating overloaded methods."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "The keyword used to define a method in Java.",
            answer: "Method",
            hints: [
                "Hint 1: It is defined using a return type, a name, and a parameter list.",
                "Hint 2: It allows an operation to be performed.",
                "Hint 3: A method can be overloaded or overridden."
            ]
        },

        {
            ...
            answer: "15 and 16.0",
            image: "/image/Custom/AW1P2F6WTO1.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            question: "Whats the Output of the Code snippet below?",
            answer: "Number: 5 and Message: Hello",
            image: "/image/Custom/AW1P2F6WTO2.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            question: "Whats the Output of the Code snippet below?",
            answer: "Int: 10 Double: 10.5 String: Java",
            image: "/image/Custom/AW1P2F6WTO3.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            question: "Whats the Output of the Code snippet below?",
            answer: "20 and 120",
            image: "/image/Custom/AW1P2F6WTO4.png"
        },
        {
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("AW1F6totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
   ...
   function showCompletionWarning() {
    ...
    AW1F6totalScore = localStorage.getItem("AW1F6totalScore") ? parseInt(localStorage.getItem("AW1F6totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		AW1F6totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("AW1F6totalScore", AW1F6totalScore);
	}
