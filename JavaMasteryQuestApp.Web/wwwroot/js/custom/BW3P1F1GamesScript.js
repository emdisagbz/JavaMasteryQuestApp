document.addEventListener("DOMContentLoaded", function() {
	...
	let BW3F1totalScore = points; // Initialize total score
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("BW3F1totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
    ...
    confirmFinishButton.addEventListener("click", function() {
        window.location.href = '/Capstone/BW3P1Floor';
    });
   ...
   function showCompletionWarning() {
    ...
    BW3F1totalScore = localStorage.getItem("BW3F1totalScore") ? parseInt(localStorage.getItem("BW3F1totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		BW3F1totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("BW3F1totalScore", BW3F1totalScore);
	}
