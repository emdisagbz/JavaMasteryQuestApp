...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("AW1F2totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
   ...
   function showCompletionWarning() {
    ...
    AW1F2totalScore = localStorage.getItem("AW1F2totalScore") ? parseInt(localStorage.getItem("AW1F2totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		AW1F2totalScore = points; // Record the total score
