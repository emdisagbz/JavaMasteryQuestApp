document.addEventListener("DOMContentLoaded", function() {
	...
	let AW3F3totalScore = points; // Initialize total score
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("AW3F3totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
   ...
   function showCompletionWarning() {
    ...
    AW3F3totalScore = localStorage.getItem("AW3F3totalScore") ? parseInt(localStorage.getItem("AW3F3totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		AW3F3totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("AW3F3totalScore", AW3F3totalScore);
	}
