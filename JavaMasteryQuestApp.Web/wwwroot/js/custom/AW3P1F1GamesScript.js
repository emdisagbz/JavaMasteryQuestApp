document.addEventListener("DOMContentLoaded", function() {
	...
	let AW3F1totalScore = points; // Initialize total score
    ...
    const questions = [
        {
            ...
            choices: [
                ...
                "B) Encapsulating data and methods into a single unit.",
                "C) Creating multiple methods with the same name.",
                "D) Inheriting properties from another class."
            ],
            answer: "A",
            hints: [
                "Hint 1: It focuses on what an object does rather than how it does it.",
                "Hint 2: It hides unnecessary details from the user.",
                "Hint 3: Abstract classes and interfaces help achieve abstraction in Java."
            ]
        },
        {
            type: "Multiple Choice",
            ...
            choices: [
                ...
                "B) Static methods and final variables",
                "C) Inheritance and polymorphism",
                "D) Encapsulation and overloading"
            ],
            answer: "A",
            hints: [
                "Hint 1: Both allow you to define methods without providing their implementation.",
                "Hint 2: Abstract classes can have both abstract and non-abstract methods.",
                "Hint 3: Interfaces can only have abstract methods (before Java 8)."
            ]
        },
        {
            type: "Multiple Choice",
            ...
            answer: "B",
            hints: [
                "Hint 1: This keyword is used to define a class that cannot be instantiated directly.",
                "Hint 2: It allows the class to have methods without implementation.",
                "Hint 3: The class can be extended by other classes to provide implementations for abstract methods."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "Hiding the implementation details and showing only the essential features.",
            answer: "Abstraction",
            hints: [
                "Hint 1: It allows a focus on what the object does, not how it works.",
                "Hint 2: It simplifies code usage by hiding complex implementation details.",
                "Hint 3: It can be achieved through abstract classes and interfaces."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "A class that cannot be instantiated and may contain abstract methods.",
            answer: "Abstract class",
            hints: [
                "Hint 1: This class can have both abstract and concrete methods.",
                "Hint 2: Other classes must extend this class to provide implementations for its abstract methods.",
                "Hint 3: It is declared with the abstract keyword."
            ]
        },
        {
            type: "Identification",
            points: 3,
            question: "A completely abstract class that is used to group related methods.",
            answer: "Interface",
            hints: [
                "Hint 1: All methods in this type of class are abstract by default (before Java 8).",
                "Hint 2: It is used to define behaviors that a class must implement.",
                "Hint 3: It can be implemented by any class regardless of its place in the inheritance hierarchy."
            ]
        },

        {
            ...
            answer: "Dog barks",
            image: "/image/Custom/AW3P1F1WTO1.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            ...
            image: "/image/Custom/AW3P1F1WTO2.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            ...
            image: "/image/Custom/AW3P1F1WTO3.png"
        },
        {
            type: "Whats the Output",
            points: 3,
            question: "Whats the Output of the Code snippet below?",
            answer: "Washing machine is on",
            image: "/image/Custom/AW3P1F1WTO4.png"
        },
        {
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("AW3F1totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
   ...
   function showCompletionWarning() {
    ...
    AW3F1totalScore = localStorage.getItem("AW3F1totalScore") ? parseInt(localStorage.getItem("AW3F1totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		AW3F1totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("AW3F1totalScore", AW3F1totalScore);
	}
