document.addEventListener("DOMContentLoaded", function() {
	...
	let BW2F3totalScore = points; // Initialize total score
...
function updateCoinAndPointCount() {
    ...
    localStorage.setItem("BW2F3totalScore", points); // Update total score in localStorage
}
...
restartButton.addEventListener("click", restartGame);
   ...
   function showCompletionWarning() {
    ...
    BW2F3totalScore = localStorage.getItem("BW2F3totalScore") ? parseInt(localStorage.getItem("BW2F3totalScore")) : 0;
	...
	function saveTotalStats() {
		...
		BW2F3totalScore = points; // Record the total score

		localStorage.setItem("totalAttempts", totalAttempts);
		localStorage.setItem("BW2F3totalScore", BW2F3totalScore);
	}
