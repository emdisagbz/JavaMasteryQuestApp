...
document.addEventListener("DOMContentLoaded", function () {
    ...
    heroShopButton.addEventListener("click", function () {
        window.location.href = "AheroShop.html";
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    practiceButton.addEventListener("click", function () {
        window.location.href = "APractice.html";
    });
});
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    worlds.forEach(world => {
        ...
        for (let i = 0; i < world.floors; i++) {
            ...
            if (world.id === 'world-1') {
                const floorScores = [
                    localStorage.getItem('AW1F1totalScore'),
                    localStorage.getItem('AW1F2totalScore'),
                    localStorage.getItem('AW1F3totalScore'),
                    localStorage.getItem('AW1F4totalScore'),
                    localStorage.getItem('AW1F5totalScore'),
                    localStorage.getItem('AW1F6totalScore'),
                    localStorage.getItem('AW1F7totalScore')
                ];
                ...
                const floorScores = [
                    localStorage.getItem('AW2F1totalScore'),
                    localStorage.getItem('AW2F2totalScore'),
                    localStorage.getItem('AW2F3totalScore'),
                    localStorage.getItem('AW2F4totalScore')
                ];
                const score = floorScores[i] ? parseInt(floorScores[i]) : 0;
                floorPoints.textContent = `${score} points`;
                totalPoints += score;
                ...
                const floorScores = [
                    localStorage.getItem('AW3F1totalScore'),
                    localStorage.getItem('AW3F2totalScore'),
                    localStorage.getItem('AW3F3totalScore'),
                ];
                const score = floorScores[i] ? parseInt(floorScores[i]) : 0;
                floorPoints.textContent = `${score} points`;
                totalPoints += score;
